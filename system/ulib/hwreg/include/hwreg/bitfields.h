...
#define DEF_SUBFIELD(FIELD, BIT_HIGH, BIT_LOW, NAME)                                              \
    typename fbl::remove_reference<decltype(FIELD)>::type NAME()                                  \
    {                                                                                             \
        return hwreg::BitfieldRef<typename fbl::remove_reference<decltype(FIELD)>::type>(         \
...
#define DEF_SUBBIT(FIELD, BIT, NAME)                                                              \
    ...
    {                                                                                             \
        static_assert((BIT) <                                                                     \
                      sizeof(typename fbl::remove_reference<decltype(FIELD)>::type) * CHAR_BIT,   \
                      "Bit is out of range");                                                     \
        return hwreg::BitfieldRef<typename fbl::remove_reference<decltype(FIELD)>::type>(         \
                &FIELD, (BIT), (BIT)).get();                                                      \
    }                                                                                             \
